 ...
 */
public class BPinnedHeaderItemDecoration extends RecyclerView.ItemDecoration implements IPinnedHeaderDecoration {
	...
	public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
		...
		if (parent.getAdapter() instanceof BaseRecyclerViewAdapter && parent.getChildCount() > 0) {
